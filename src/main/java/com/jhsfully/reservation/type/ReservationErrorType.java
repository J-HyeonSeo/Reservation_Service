...
public enum ReservationErrorType {
    ...
    RESERVATION_CANNOT_ALLOW_ZERO("0명의 예약은 허용하지 않습니다."),
    RESERVATION_CANNOT_ALLOW_GREEDY_USER("같은 날에 2번 이상의 예약은 불가능합니다."),
    ...
    RESERVATION_CANNOT_VISIT_NOT_ASSIGN("승인되지 않은 예약은 방문할 수 없습니다."),
